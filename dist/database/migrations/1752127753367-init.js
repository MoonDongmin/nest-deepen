...
exports.Init1752127753367 = void 0;
class Init1752127753367 {
    constructor() {
        this.name = 'Init1752127753367';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "movie_detail"
                             (
                               "id"     SERIAL            NOT NULL,
        ...
        await queryRunner.query(`CREATE TABLE "movie_user_like"
                             (
        ...
        await queryRunner.query(`CREATE TABLE "movie"
                             (
                               ...
                               "movieFilePath" character varying NOT NULL,
                               "creatorId"     integer,
                               "detailId"      integer           NOT NULL,
                               "directorId"    integer           NOT NULL,
                               CONSTRAINT "UQ_a81090ad0ceb645f30f9399c347" UNIQUE ("title"),
                               CONSTRAINT "REL_87276a4fc1647d6db559f61f89" UNIQUE ("detailId"),
        ...
        await queryRunner.query(`CREATE TABLE "movie_genres_genre"
                             (
                               "movieId" integer NOT NULL,
        ...
        await queryRunner.query(`ALTER TABLE "movie_user_like"
      ...
      ADD CONSTRAINT "FK_6a4d1cde9def796ad01b9ede541" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "movie"
      ADD CONSTRAINT "FK_b55916de756e46290d52c70fc04" FOREIGN KEY ("creatorId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "movie"
      ADD CONSTRAINT "FK_87276a4fc1647d6db559f61f89a" FOREIGN KEY ("detailId") REFERENCES "movie_detail" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "movie"
      ADD CONSTRAINT "FK_a32a80a88aff67851cf5b75d1cb" FOREIGN KEY ("directorId") REFERENCES "director" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "movie_genres_genre"
...
exports.Init1752127753367 = Init1752127753367;
//# sourceMappingURL=1752127753367-init.js.map